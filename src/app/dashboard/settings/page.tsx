...
export default function SettingsPage() {
  ...
  const selectCls = "w-full bg-white border border-slate-200 rounded-lg px-3 py-2 text-sm text-slate-800 focus:outline-none focus:border-indigo-400 focus:ring-2 focus:ring-indigo-500/20 transition-all appearance-none";
  ...
  function Toggle({ value, onChange }: { value: boolean; onChange: (v: boolean) => void }) {
    return (
      <button
        ...
        className={`relative inline-flex h-5 w-9 items-center rounded-full transition-colors flex-shrink-0 ${value ? "bg-indigo-500" : "bg-slate-200"}`}
      >
        <span
    ...
    <div className="min-h-dvh bg-slate-50">
      <main className="max-w-2xl mx-auto px-6 py-8 space-y-6">
        ...
        <div>
          ...
          <p className="text-slate-400 text-sm mt-0.5">Manage your preferences and account settings.</p>
        </div>
        ...
        <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden">
          <div className="flex items-center gap-3 px-5 py-4 border-b border-slate-100">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-400">Name, timezone, and language preferences.</p>
            </div>
          </div>
        ...
        <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden">
          <div className="flex items-center gap-3 px-5 py-4 border-b border-slate-100">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-400">Theme and layout preferences.</p>
            </div>
          </div>
          <div className="px-5 py-4 space-y-4">
            {/* Theme selector */}
            <div>
              <label className="block text-xs text-slate-500 mb-2">Theme</label>
            ...
            {/* Sidebar behavior */}
            <div>
              <label className="block text-xs text-slate-500 mb-1">Sidebar Default</label>
              <SelectWrapper>
                <select value={sidebarBehavior} onChange={e => setSidebarBehavior(e.target.value as SidebarBehavior)} className={selectCls}>
            ...
            <div className="flex items-center justify-between py-1">
              <div>
                <p className="text-xs font-semibold text-slate-700">Compact Mode</p>
                <p className="text-[11px] text-slate-400 mt-0.5">Reduce spacing and padding in tables and lists.</p>
              </div>
        ...
        <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden">
          <div className="flex items-center gap-3 px-5 py-4 border-b border-slate-100">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-400">Choose how and when you get notified.</p>
            </div>
          </div>
        ...
        <div className="bg-white border border-red-200 rounded-2xl overflow-hidden">
          <div className="flex items-center gap-3 px-5 py-4 border-b border-red-100">
            ...
            <div>
              ...
              <p className="text-[11px] text-red-400">Irreversible account actions.</p>
            </div>
          </div>
          <div className="px-5 py-4 space-y-4">
            <div className="flex items-start justify-between gap-4">
              <div>
                <p className="text-xs font-semibold text-slate-700">Delete Account</p>
                <p className="text-[11px] text-slate-400 mt-0.5">Permanently delete your account and all data. This cannot be undone.</p>
              </div>
              <button
                onClick={() => setShowDeleteConfirm(s => !s)}
                className="flex items-center gap-1.5 px-3 py-2 rounded-xl border border-red-200 bg-red-50 text-red-500 text-xs font-semibold hover:bg-red-100 transition-colors flex-shrink-0"
              >
            ...
            {showDeleteConfirm && (
              <div className="p-4 rounded-xl bg-red-50 border border-red-200 space-y-3">
                ...
                <input
                  ...
                  className="w-full bg-white border border-red-200 rounded-lg px-3 py-2 text-sm text-slate-800 placeholder:text-slate-400 focus:outline-none focus:border-red-400 focus:ring-2 focus:ring-red-500/20 transition-all"
                />
